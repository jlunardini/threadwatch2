<template>
    <jet-action-section>
        ...
        <template #content>
            <h3 class="text-lg font-medium text-gray-400" v-if="twoFactorEnabled">You have enabled two factor authentication.</h3>

            <h3 class="text-lg font-medium text-gray-400" v-else>You have not enabled two factor authentication.</h3>
